...
import cs3500.image.view.ImageView;
...
public class ImageControllerImpl implements ImageController {
  ...
  private final HashMap<String, ImageModel> modelList;
   ...
   *
   * @param view the view to render user input into
   */
  ...
  protected void processCommand(String userInstruction, Scanner sc) {
    ...
    switch (userInstruction) {
      ...
      case "red-component":
        ...
        modelNameTo = sc.next();
        try {
          modelList.put(modelNameTo, RedGrayScale.execute(modelList.get(modelName)));
      ...
      case "green-component":
        ...
        modelNameTo = sc.next();
        try {
          modelList.put(modelNameTo, GreenGrayScale.execute(modelList.get(modelName)));
      ...
      case "blue-component":
        ...
        modelNameTo = sc.next();
        try {
          modelList.put(modelNameTo, BlueGrayScale.execute(modelList.get(modelName)));
      ...
      case "luma-component":
        ...
        modelNameTo = sc.next();
        try {
          modelList.put(modelNameTo, LumaGrayScale.execute(modelList.get(modelName)));
      ...
      case "value-component":
        ...
        modelNameTo = sc.next();
        try {
          modelList.put(modelNameTo, ValueGrayScale.execute(modelList.get(modelName)));
      ...
      case "intensity-component":
        ...
        modelNameTo = sc.next();
        try {
          modelList.put(modelNameTo, IntensityGrayScale.execute(modelList.get(modelName)));
