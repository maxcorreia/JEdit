...
public class Controller2Test {
  ...
  @Test
  public void testScriptRun() throws FileNotFoundException {
    in = new FileReader("res/test.txt");
    out = new StringBuilder();
    model = new ImageGallery();
    view = new ImageViewImpl(out);
    controller = new ImageController2(model, view, in);
    controller.runProgram();
    assertEquals(Load.load("res/dolphin.ppm"), Load.load("res/newer-dolphin.ppm"));
  }

  @Test(expected = FileNotFoundException.class)
  public void testScriptNotFound() throws FileNotFoundException {
    in = new FileReader("res/boston.txt");
    out = new StringBuilder();
    model = new ImageGallery();
    view = new ImageViewImpl(out);
    controller = new ImageController2(model, view, in);
